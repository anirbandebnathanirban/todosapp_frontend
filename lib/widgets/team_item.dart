            ...
            child: ClipRRect(
              ...
              child: ExpansionTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    Text(
                        'DESCRIPTION: ${team.teamBasicDetails.teamDescription}',
                        style: const TextStyle(color: Colors.blueAccent)),
                    Text(
                        'TEAM CREATION DATE: ${team.teamBasicDetails.teamCreationTime.toString().split(' ')[0]}',
                        style: const TextStyle(color: Colors.blueAccent)),
                    Text(
                        '${member1!.userName.userFirstName} ${member1.userName.userLastName}, ${member2!.userName.userFirstName} ${member2.userName.userLastName}, ...',
                        style: const TextStyle(color: Colors.blueAccent)),
                  ],
                ),
                children: [
                  Row(
                    ...
                    children: [
                      TextButton.icon(
                        ...
                        icon:
                            const Icon(Icons.details, color: Colors.blueAccent),
